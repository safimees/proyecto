...
for(ren=0; ren<3; ren++)
  ...
  r=Math.round(r/divisor); g=Math.round(g/divisor); b=Math.round(b/divisor);
...
function brillo(){
  ...
  br = parseInt(document.getElementById('br').value);
  ...
  mConv= new Array ();
  mConv[0] = new Array (ar, ag, ab);
  mConv[1] = new Array (br, bg, bb);
  mConv[2] = new Array (cr, cg, cb);
  divisor = divisor;
  bias = bias;
  procesar();
}
